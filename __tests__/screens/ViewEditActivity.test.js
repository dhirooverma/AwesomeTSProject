...
import ViewEditActivity from '../../src/screens/ViewEditActivity';
import InputText from '../../src/components/InputText';
import SelectBox from '../../src/components/SelectBox';
import Label from '../../src/components/Label';
import Button from '../../src/components/Button';

describe('ViewEditActivity component', () => {
  ...
  it('useEffect hook sets loading state to false after submission', async () => {
    const onSubmitMock = jest.fn();
    const {getByTestId} = render(<ViewEditActivity onSubmit={onSubmitMock} />);
...
describe('ViewEditActivity', () => {
  it('renders correctly', () => {
    const {getByTestId} = render(<ViewEditActivity />);
    expect(getByTestId('ViewEditActivity')).toBeDefined();
  });
  it('should update the state when input text is changed', () => {
    const {getByTestId} = render(<ViewEditActivity testID="activityInput" />);
